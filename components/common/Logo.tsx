...
const Logo = ({ className, variant = "default" }: Props) => {
  ...
  if (variant === "sm") {
    return (
      <Link href={"/"}>
        ...
        >
          {/* Heart Icon with Creative Styling (smaller) */}
          <div className="relative">
            ...
            <Heart
              className="w-5 h-5 text-shop_dark_green group-hover:text-red-500 hoverEffect transform group-hover:scale-110 fill-current"
              strokeWidth={2.5}
            />
          </div>
  ...
  return (
    <Link href={"/"}>
      ...
      >
        {/* Heart Icon with Creative Styling */}
        <div className="relative">
          ...
          <Heart
            className="w-8 h-8 text-shop_dark_green group-hover:text-red-500 hoverEffect transform group-hover:scale-110 fill-current"
            strokeWidth={2.5}
          />
        </div>
