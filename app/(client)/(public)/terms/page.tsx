        ...
        <Container className="max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Please read these terms carefully before using our dating services. They outline your
              rights and responsibilities as a FindLove member.
            </p>
        ...
        <Container className="max-w-6xl">
          ...
          >
            <Card className="bg-white shadow-lg">
              <CardHeader>
                <CardTitle className="text-center text-shop_dark_green">Quick Navigation</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-white shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  If you have any questions about these Terms of Service or need clarification on
                  any dating-related policies, our support team is here to help.
                </p>
